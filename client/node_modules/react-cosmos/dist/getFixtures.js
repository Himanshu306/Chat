...
function getFixtures(_x) {
  return _getFixtures.apply(this, arguments);
}

function _getFixtures() {
  _getFixtures = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(_ref) {
    var cosmosConfig, _ref2, fixtureExportsByPath, decoratorsByPath, fixtures;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            _ref2 = _context.sent;
            fixtureExportsByPath = _ref2.fixtureExportsByPath;
            decoratorsByPath = _ref2.decoratorsByPath;
            fixtures = [];
